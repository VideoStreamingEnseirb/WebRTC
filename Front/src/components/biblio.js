      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="card-text ml-3 mr-3">
              <p>
              In this section, are listed links which have been used to understand WebRTC protocol and for the redaction of this web page.
              </p>
          ...
          <ul>
            ...
            <li> This page allowed us to understand the WebRTC project in his globality: <br /><a href="https://en.wikipedia.org/wiki/WebRTC"> https://en.wikipedia.org/wiki/WebRTC </a>  </li>
