...
Direct exchanges between navigators already existed thanks to the creation of different plugins like Adobe Flash or Microsoft Active X.
                         ...
                         To overcome this lack of coherence <strong>WebRTC</strong> <em>(Web Real-Time Communication)</em> has been created by Justin Uberti and Peter Thatcher.
                    ...
                    <p> <strong>WebRTC</strong> <em>(Web Real-Time Communication)</em> main purpose is to provide <strong>real-time communication</strong>, it is an API that has three main services and is based on a Javascript API. It involves two different entities : <em>client</em> and <em>server</em>. The server is here to initialize the connection between the two peers before they communicate with each other directly by sharing data, audio and even video stream. </p>
                    ...
                    <div class="row mb-3">
                        <div class="col-md card mr-2">
                            <a href={InitiationPhase}><img className="img-fluid mx-auto d-block mt-4" src={InitiationPhase} alt="FrontLaunch" style={{ "width": "100%" }}></img></a>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md card mr-2">
                        <a href={PeerCommunication}><img className="img-fluid mx-auto d-block mt-3" src={PeerCommunication} alt="FrontLaunch" style={{ "width": "100%" }}></img></a>
                        </div>
                        <div class="col-md card">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md">
                            ...
                            <div className="card-text text-justify ml-3 mr-3">
                                <p>We can showcase WebRTC technology through multiple application :</p>
                                <ul>
